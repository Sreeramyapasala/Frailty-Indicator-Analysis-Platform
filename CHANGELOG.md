...
ZonePositionError / warning messageTop — full-width red barInstruction textBelow error — black background barStatus messageBelow instruction — centeredCamera feedMiddle of screen30-second timerBottom — black background bar
